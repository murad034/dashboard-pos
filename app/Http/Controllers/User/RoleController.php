...
class RoleController extends Controller
{
    ...
    public function store(StoreRoleRequest $request): \Illuminate\Http\RedirectResponse
    {
        ...
        $this->saveLog("created role : ".json_encode($request->all()), Role::tableName());
    ...
    public function update(UpdateRoleRequest $request, $id)
    {
        ...
        $this->saveLog("updated role: ". json_encode($request->all()), Role::tableName());
    ...
    public function destroy($id): \Illuminate\Http\RedirectResponse
    {
        ...
        $this->saveLog("deleted role", Role::tableName());
