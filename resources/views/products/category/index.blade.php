...
{{--                        @endforeach--}}
        ...
        <div class="offcanvas-body">
            ...
            <div class="col-md-12">
                <label for="subcatagoryname">
                    Sub Category Name :
                </label><input type="text" class="productinput form-control" id="subcatagoryname"
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample3" aria-labelledby="offcanvasExampleLabe3"
        ...
        <div class="offcanvas-body">
            ...
            <button type="button" name="import" id="import_main" class="btn btn-success rounded-0"
                    style="display:none;">Import
            </button>
    ...
    <script src="{{ asset('/js/products/category/index.js') }}"></script>
@endsection
