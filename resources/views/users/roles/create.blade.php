                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('label') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="label" class="form-control" placeholder="Description"
                            ...
                            <div class="col-lg-12">
                                ...
                                @foreach($permission_groups as $permission_group)
                                    @if($permission_group->permission_group_id > 1)
                                        <div class="panel box box-default">
                                            <div class="box-header with-border">
                                                <h4 class="box-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#{{ $permission_group->permission_group_id }}"
                                                       aria-expanded="false" class="collapsed">
                                                        {{ $permission_group->name }}
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="{{ $permission_group->permission_group_id }}"
                                                    ...
                                                    @foreach($permission_group->permissions as $permission)
                                                        <div class="col-lg-3">
                                                            <label><input type="checkbox" name="permissions[]"
                                                                          ...
                                                                          class="icheck minimal"> {{ $permission->label }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                                </div>
                            ...
                            <div class="col-lg-6">
                                <button type="submit" class="btn btn-primary float-end"><i class="fa fa-fw fa-plus"></i>
                                    Add
                                </button>
                            </div>
                        </div>
