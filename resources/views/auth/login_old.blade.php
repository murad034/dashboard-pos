...
<div id="box-login-personalize">
    <div class="login-logo">
        ...
        @if(\App\Models\Config::find(1)->img_login == 'T')
            <img src="{{ asset(\App\Models\Config::find(1)->logo_background) }}"
                 width="{{ \App\Models\Config::find(1)->tamanho_img_login }}%"/>
            <br/>
        @endif
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to the DashBoard</p>
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <div class="form-group has-feedback">
                <input id="email" type="text" class="form-control" placeholder="User Email" name="email"
                       value="{{ old('email') }}" autofocus required="" AUTOCOMPLETE='off'>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback" style="padding-top:15px; padding-bottom: 15px;">
