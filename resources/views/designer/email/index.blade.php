...
@section('content')
            ...
            <div class="offcanvas-body">
                ...
                <div class="row" style="margin-bottom: 20px;padding:0;">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="template-input form-control" id="templatedescription"
                               name="templatedescription" placeholder="Template Description" required>
                    </div>
                </div>
    ...
    <script src="{{ asset('/js/designer/email/index.js') }}"></script>
@endsection
