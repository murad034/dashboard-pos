...
class CreateConfigsTable extends Migration
{
    ...
    public function up()
    {
        if (!Schema::connection('mongodb')->hasTable('configs')){
            Schema::connection('mongodb')->create('configs', function (Blueprint $table) {
                $table->increments('id');
                //Config App
    ...
    {
        Schema::connection('mongodb')->dropIfExists('configs');
    }
}
