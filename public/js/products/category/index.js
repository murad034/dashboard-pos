...
$(document).ready(function () {
    ...
    $("#upload_main_form").on("submit", function (event) {
        ...
        $.ajax({
            url: "/product-categories/cat-upload",
            method: "POST",
    ...
    $(document).on("click", "#import_main", function (event) {
        if (!("catid" in column_data)) {
            ...
            $.ajax({
                url: "/product-categories/cat-import",
                method: "POST",
                data: column_data,
                success: function (data) {
    ...
    $("#upload_sub_form").on("submit", function (event) {
        event.preventDefault();
        $.ajax({
            url: "/product-categories/sub-upload",
            method: "POST",
            data: new FormData(this),
            dataType: "json",
            contentType: false,
    ...
    $(document).on("click", "#import_sub", function (event) {
        if (!("subcatid" in column_data)) {
            ...
            $.ajax({
                url: "/product-categories/sub-import",
                method: "POST",
                data: column_data,
                success: function (data) {
                    if (data.status === "success") {
    ...
    $("#example1").DataTable({
        ...
        ajax: {
            url: "/product-categories/cat-api",
            method: "GET",
        },
        columnDefs: [
            {
    ...
    $("#example12").DataTable({
        ...
        ajax: {
            url: "/product-categories/sub-api",
            method: "GET",
        },
        columnDefs: [
            {
...
function getShowStatus(item) {
    $("#example1")
        .DataTable()
        .ajax.url("product-categories/cat-api?status=" + item.value)
        .load();
}
...
function getShowStatus1(item) {
    $("#example12")
        .DataTable()
        .ajax.url("product-categories/sub-api?status=" + item.value)
        .load();
}
    ...
    swal(
        ...
        function (isConfirm) {
            if (isConfirm) {
                $.ajax({
                    method: "PUT",
                    url: "/product-categories/cat-api/" + id,
                    data: {
                        status: "active",
                    },
                })
                        ...
                        if (data.status === "success") {
                            swal(
                                ...
                                function (isConfirm) {
                                    ...
                                    $("#example1")
                                        .DataTable()
                                        .ajax.url("product-categories/cat-api")
                                        .load();
                                }
                            );
                        } else {
...
function updateMainCat() {
    if ($("#catagoryname").val() !== "") {
        $.ajax({
            ...
            url: "/product-categories/cat-api/" + tempMainId,
            data: {
                catagoryname: $("#catagoryname").val(),
            },
            success: function (data) {
    ...
    swal(
        ...
        function (isConfirm) {
            if (isConfirm) {
                $.ajax({
                    method: "PUT",
                    url: "/product-categories/sub-api/" + id,
                    data: {
                        status: "active",
                    },
                })
                        ...
                        if (data.status === "success") {
                            swal(
                                ...
                                function (isConfirm) {
                                    ...
                                    $("#example12")
                                        .DataTable()
                                        .ajax.url("product-categories/sub-api")
                                        .load();
                                }
                            );
                        } else {
...
function updateSubCat() {
    if ($("#subcatagoryname").val() !== "") {
        $.ajax({
            type: "PUT",
            url: "/product-categories/sub-api/" + tempSubId,
            data: {
                subcatagoryname: $("#subcatagoryname").val(),
            },
            success: function (data) {
